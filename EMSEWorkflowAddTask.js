...
//var sourceTaskName= "Public Works Review";
//var newTaskName= "EMSEnewTaskName";
//var insertTaskType= "N";
//var cap = "COM-NEW-22-001308";

var sourceTaskName= aa.env.getValue("sourceTaskName");
var newTaskName= aa.env.getValue("newTaskName");
var insertTaskType= aa.env.getValue("insertTaskType");

var cap = aa.env.getValue("capId");
var result = aa.cap.getCapID(cap);
var capId = result.getOutput();
var appCreateResult = addTask(sourceTaskName, newTaskName, insertTaskType, capId);
