...
//Example
//var pType= "Building Permit";
//var pStatus= "Applied";
//var pDesc= "As Built Plans";
//var pImpact= "Notice";
//var cap = "COM-NEW-22-000620";
...
var appCreateResult = getConditions(pType, pStatus, pDesc, pImpact, capId);
var nums = appCreateResult.length.toString()
...
aa.env.setValue("ScriptReturnMessage", nums);
}
