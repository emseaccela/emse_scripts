...
//var cComment= "Test EMSE Comment";
//var cImpact= "Notice";
//var stateLicNum= "74489";
...
var stateLicNum= aa.env.getValue("stateLicNum");


//var cap = "COM-NEW-22-001426";
var cap = aa.env.getValue("capId");
var result = aa.cap.getCapID(cap);
var capId = result.getOutput();

var appCreateResult = addLicenseCondition(cType, cStatus,  cDesc, cComment, cImpact, stateLicNum, capId);
