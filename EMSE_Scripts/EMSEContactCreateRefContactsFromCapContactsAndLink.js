...
var cap = aa.env.getValue("pCapId");
var result = aa.cap.getCapID(cap);
var pCapId= result.getOutput();

//var contactTypeArray = aa.env.getValue("contactTypeArray");
//var ignoreAttributeArray = aa.env.getValue("ignoreAttributeArray");
//var replaceCapContact = aa.env.getValue("replaceCapContact");
//var overwriteRefContact= aa.env.getValue("overwriteRefContact");
//var refContactExists = aa.env.getValue("refContactExists");

var contactTypeArray = "null";
var ignoreAttributeArray = "null";
var replaceCapContact = false;
var overwriteRefContact= false;
var refContactExists = comparePeopleGeneric;


var appCreateResult = createRefContactsFromCapContactsAndLink(pCapId, contactTypeArray, ignoreAttributeArray, replaceCapContact, overwriteRefContact, refContactExists);
