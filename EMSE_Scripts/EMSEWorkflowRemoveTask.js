...
//var cap = "COM-NEW-22-001367";
var cap = aa.env.getValue("targetCapId");
var result = aa.cap.getCapID(cap);
var targetCapId= result.getOutput();

//var removeTaskName= "Public Works Review";
//var wfProcess= "BLDG_COM_GEN";
var removeTaskName= aa.env.getValue("removeTaskName");
var wfProcess= aa.env.getValue("wfProcess");

var appCreateResult = removeTask(targetCapId, removeTaskName, wfProcess);
