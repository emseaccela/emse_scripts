...
var mSubj = aa.env.getValue("mSubj");
var mText = aa.env.getValue("mText");
var contactType = aa.env.getValue("contactType");

var cap = aa.env.getValue("capId");
var result = aa.cap.getCapID(cap);
var capId = result.getOutput();

var appCreateResult = emailContact(mSubj,mText,contactType,capId);
