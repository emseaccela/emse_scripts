...
var vFirst = aa.env.getValue("vFirst");
var vMiddle = aa.env.getValue("vMiddle");
var vLast = aa.env.getValue("vLast");

var cap = aa.env.getValue("capId");
var result = aa.cap.getCapID(cap);
var capId = result.getOutput();

var appCreateResult = addReferenceContactByName(vFirst,vMiddle,vLast,capId);
