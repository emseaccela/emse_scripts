...
var pProjType= aa.env.getValue("pProjType");
var pSearchType= aa.env.getValue("pSearchType");
//var pProjType= "Building/Commercial/*/*";
//var pSearchType= "Building/*/*/*";


//var cap = "COM-NEW-22-003018";
var cap = aa.env.getValue("capId");
var result = aa.cap.getCapID(cap);
var capId = result.getOutput();

var appCreateResult = searchProject(pProjType, pSearchType, capId);
