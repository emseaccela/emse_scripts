...
//var channel = "PHONE";
var channel = aa.env.getValue("channel");

var cap = aa.env.getValue("capId");
var result = aa.cap.getCapID(cap);
var capId = result.getOutput();

var appCreateResult = editChannelReported(channel,capId);
...
var channel = "PHONE";                               // some records have empty drop down menu
                                                     // need to check where to keep this data  to not hardcode it here
