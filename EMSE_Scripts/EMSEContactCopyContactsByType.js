...
var pContactType = aa.env.getValue("pContactType");

var cap = aa.env.getValue("pFromCapId");
var result = aa.cap.getCapID(cap);
var pFromCapId = result.getOutput();

var cap = aa.env.getValue("pToCapId");
var result = aa.cap.getCapID(cap);
var pToCapId = result.getOutput();

var appCreateResult = copyContactsByType(pFromCapId, pToCapId, pContactType);
