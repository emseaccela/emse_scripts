...
var insp2Check = aa.env.getValue("insp2Check");
var insp2Result = aa.env.getValue("insp2Result");

var cap = aa.env.getValue("capId");
var result = aa.cap.getCapID(cap);
var capId = result.getOutput();

var appCreateResult = checkInspectionResult(insp2Check,insp2Result,capId);
