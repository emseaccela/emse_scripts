...
//var wfRelationSeqId= 025001000000000;
//var cap = "COM-NEW-22-001085";

var wfstr= aa.env.getValue("wfstr");
var wfRelationSeqId= aa.env.getValue("wfRelationSeqId");
var cap = aa.env.getValue("capId");
var result = aa.cap.getCapID(cap);
var capId = result.getOutput();

var appCreateResult = activateTask(wfstr, wfRelationSeqId, capId);
