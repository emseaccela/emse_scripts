...
var ats= aa.env.getValue("ats");
//var ats= "Building/Commercial/New/NA";


//var cap = "COM-NEW-22-002901";
var cap = aa.env.getValue("capId");
var result = aa.cap.getCapID(cap);
var capId = result.getOutput();

var appCreateResult = getRelatedCapsByAddress(ats,capId);
var nums = appCreateResult.length
