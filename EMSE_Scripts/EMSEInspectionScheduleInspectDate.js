...
var iType = aa.env.getValue("iType");
var DateToSched = aa.env.getValue("DateToSched");
var inspectorID = aa.env.getValue("inspectorID");
var inspTime = aa.env.getValue("inspTime");
var inspComm = aa.env.getValue("inspComm");

var cap = aa.env.getValue("capId");
var result = aa.cap.getCapID(cap);
var capId = result.getOutput();

var appCreateResult = scheduleInspectDate(iType,DateToSched,inspectorID,inspTime,inspComm,capId);
