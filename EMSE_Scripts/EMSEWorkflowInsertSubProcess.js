...
//var taskName= "Public Works Review";
//var process= "BLDG_COM_GEN";
//var completeReqd= false;
//var cap = "COM-NEW-22-001350";

var taskName= aa.env.getValue("taskName");
var process= aa.env.getValue("process");
//var completeReqd= aa.env.getValue("completeReqd");
var completeReqd= false;
...
var appCreateResult = insertSubProcess(taskName, process, completeReqd, capId);
