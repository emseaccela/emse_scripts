...
//var licnumber= "43419";
//var lictype= "Contractor";

var licnumber= aa.env.getValue("rlpId");
var lictype= aa.env.getValue("rlpType");

var appCreateResult = licenseProfObject(licnumber, lictype);
...
aa.env.setValue("ScriptReturnMessage", appCreateResult.valid);
}
