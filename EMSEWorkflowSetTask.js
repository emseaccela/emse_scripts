...
//var wfstr= "EMSEnewTaskName161";
//var isOpen= "N";
//var isComplete= "Y";
//var processName= "BLDG_COM_GEN";
//var cap = "COM-NEW-22-001356";


var wfstr= aa.env.getValue("wfstr");
var isOpen= aa.env.getValue("isOpen");
var isComplete= aa.env.getValue("isComplete");
var processName= aa.env.getValue("processName");

var cap = aa.env.getValue("capId");
var result = aa.cap.getCapID(cap);
var capId = result.getOutput();

var appCreateResult = setTask(wfstr, isOpen, isComplete, processName, capId);
